...
public class MetaDataRegressionTest extends BaseTestCase {
     ...
     * com.example.stevie.connection is referenced.
     * 
     * @throws Exception
     */
     ...
     * com.example.stevie.connection character aren't retrieved correctly in ResultSetMetadata.
     * 
     * @throws Exception
     *             if the test fails.
     */
     ...
     * lower-case table names is misbehaving when com.example.stevie.connection is not attached to
     ...
     * identifiers correctly a new behavior was added to pedantic mode (com.example.stevie.connection property pedantic=true),
    ...
    public void testBug35115() throws Exception {
        ...
        /*
         * test com.example.stevie.connection with property 'yearIsDateType=false'
         */
        ...
        /*
         * test com.example.stevie.connection with property 'yearIsDateType=true'
         */
