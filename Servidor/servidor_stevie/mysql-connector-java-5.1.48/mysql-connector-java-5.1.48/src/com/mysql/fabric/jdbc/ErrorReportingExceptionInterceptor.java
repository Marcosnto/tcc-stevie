 ...
 * but instead require the com.example.stevie.connection to instantiate the provided class.
 */
public class ErrorReportingExceptionInterceptor implements ExceptionInterceptor {
    ...
    public SQLException interceptException(SQLException sqlEx, Connection conn) {
        ...
        // don't intercept exceptions during initialization, before the proxy has a chance to setProxy() on the physical com.example.stevie.connection
