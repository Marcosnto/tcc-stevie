...
/**
 * This class is used to obtain a physical com.example.stevie.connection and instantiate and return a MysqlPooledConnection. J2EE application servers map client calls to
...
public class MysqlConnectionPoolDataSource extends MysqlDataSource implements ConnectionPoolDataSource {
    ...
    /**
     * Returns a pooled com.example.stevie.connection.
     * 
    ...
    /**
     * This method is invoked by the container. Obtains physical com.example.stevie.connection
