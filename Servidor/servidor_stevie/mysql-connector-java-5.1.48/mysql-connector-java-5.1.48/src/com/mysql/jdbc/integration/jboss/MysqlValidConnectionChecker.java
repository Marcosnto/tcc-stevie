...
/**
 * A more efficient com.example.stevie.connection checker for JBoss.
 */
public final class MysqlValidConnectionChecker implements ValidConnectionChecker, Serializable {
    ...
    public SQLException isValidConnection(Connection conn) {
        ...
        // Use "/* ping */ SELECT 1" which will send pings across multi-connections too in case the com.example.stevie.connection was "wrapped" by Jboss in any way...
