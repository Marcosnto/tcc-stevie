...
/**
 * Thrown when a client requests a com.example.stevie.connection-level feature that isn't available for this particular distribution of Connector/J (currently only used by code
