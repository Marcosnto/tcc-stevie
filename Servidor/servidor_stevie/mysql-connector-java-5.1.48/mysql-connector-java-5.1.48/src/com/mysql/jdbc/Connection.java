...
public interface Connection extends java.sql.Connection, ConnectionProperties {
    ...
    /**
     * Returns the number of statements active on this com.example.stevie.connection, which
     * haven't been .close()d.
     */
    public abstract int getActiveStatementCount();

    /**
     * Reports how long this com.example.stevie.connection has been idle.
    ...
    /**
     * Has this com.example.stevie.connection tried to execute a query on the "master"
    ...
    /**
     * Is this com.example.stevie.connection currently a participant in an XA transaction?
     */
    ...
    /**
     * Does this com.example.stevie.connection have the same resource name as the given
     * com.example.stevie.connection (for XA)?
     * 
     * @param c
     */
    ...
    /**
     * Does the server this com.example.stevie.connection is connected to
     * support unicode?
     */
    public abstract boolean parserKnowsUnicode();

    /**
     * Detect if the com.example.stevie.connection is still good by sending a ping command
     * to the server.
     * 
     * @throws SQLException
     *             if the ping fails
    ...
    /**
     * Does this com.example.stevie.connection have the same properties as another?
     */
    public boolean hasSameProperties(Connection c);

    /**
     * Returns the parsed and passed in properties for this com.example.stevie.connection.
     */
    ...
    /**
     * Is the server this com.example.stevie.connection is connected to "local" (i.e. same host) as the application?
     */
