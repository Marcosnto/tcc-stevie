...
public class StringUtils {
     ...
     *            is our com.example.stevie.connection in no BackSlashEscape mode
     * @return the input string with all comment-delimited data removed
     */
     ...
     *            ` or "
     * @param identifier
     *            in pedantic mode (com.example.stevie.connection property pedantic=true) identifier is treated as unquoted
