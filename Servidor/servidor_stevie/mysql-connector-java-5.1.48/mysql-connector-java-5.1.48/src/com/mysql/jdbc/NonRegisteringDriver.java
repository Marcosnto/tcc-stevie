 ...
 * 
 * <p>
 * The DriverManager will try to load as many drivers as it can find and then for any given com.example.stevie.connection request, it will ask each driver in turn to try to
...
public class NonRegisteringDriver implements java.sql.Driver {
     ...
     * for MySQL com.example.stevie.connection attributes
     * 
    ...
    /**
     * Try to make a database com.example.stevie.connection to the given URL. The driver should return "null" if it realizes it is the wrong kind of driver to connect to the given
     ...
     * 
     * <p>
     * The java.util.Properties argument can be used to pass arbitrary string tag/value pairs as com.example.stevie.connection arguments. These properties take precedence over any
     ...
     * @param info
     *            a list of arbitrary tag/value pairs as com.example.stevie.connection arguments
     * 
     * @return a com.example.stevie.connection to the URL or null if it isn't us
     * 
     * @exception SQLException
     *                if a database access error occurs or the url is null
     * 
