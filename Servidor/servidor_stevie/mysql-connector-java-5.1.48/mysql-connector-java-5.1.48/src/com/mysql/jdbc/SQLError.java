...
public class SQLError {
     ...
     * 
     * @param connection
     *            the com.example.stevie.connection to use for getting warnings.
     * 
    ...
    static SQLWarning convertShowWarningsToSQLWarnings(Connection connection, int warningCountIfKnown, boolean forTruncationOnly) throws SQLException {
        ...
        try {
            if (warningCountIfKnown < 100) {
                ...
                stmt.setFetchSize(0); // turns off cursor based fetch, in case the com.example.stevie.connection was set up to use them.
